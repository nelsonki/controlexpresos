...
import { DriversDeleteComponent } from '../dialog/drivers-delete/drivers-delete.component'
...
export class DriversTableComponent implements OnInit {
  ...
  @ViewChild(DriversFormComponent) form: DriversFormComponent;
  ...
  constructor(
    ...
    this.titleModal = "Crear Choferes";
  }
  ...
  public openEdit(id) {
    this.titleModal = "Modificar Choferes";
    this.form.addForm(id);
  }
  eliminar(id) {
    this.dialog.open(DriversDeleteComponent, {
      width: "450px",
      data: id
    });
